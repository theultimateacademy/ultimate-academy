        ...
        <div className="landing-nav-links">
          ...
          <div ref={toolsRef} style={{ position: 'relative' }}>
            <button className="landing-nav-link"
              ...
              style={{ display: 'flex', alignItems: 'center', gap: '.3rem', color: '#C084FC', fontWeight: 600 }}>
              Outils gratuits
      ...
      <section id="tarifs" style={{ padding: '6rem 1.5rem', background: '#000', borderTop: '1px solid rgba(255,255,255,.06)' }}>
        <div className="container" style={{ maxWidth: 820 }}>
          ...
          <div className="pricing-card pricing-card--featured" style={{ padding: '3rem 2.5rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px,1fr))', gap: '3rem', alignItems: 'center', marginTop: '.5rem' }}>
