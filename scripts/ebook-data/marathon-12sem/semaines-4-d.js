...
module.exports = applyOverrides(base, {
  ...
  3: { replace: { Mercredi: {
    ...
    retour:'10 min footing très lent.',
    note:'RPE 7/10 · Deux séances de qualité cette semaine — gère bien la fatigue.' },
  ...
  5: { replace: { Mercredi: {
    ...
    echauff:'25 min progressif à {{P}}, finir par 4 accélérations 80m.',
    corps:'5 × 800m à {{P}}. Récupération 90 sec au trot. Plus court que les 6×1000m de la trame — adapté au palier débutant.',
    retour:'10 min footing très lent.',
    note:'RPE 7/10 · La régularité sur les 5 est l\'objectif principal.' },
    Dimanche: { duree:'1h50',
  ...
  6: { replace: { Mercredi: {
    ...
    Dimanche: { duree:'2h',
    corps:'2h à {{P}}, avec 6 km à allure marathon ({{OBJ}}) en fin de sortie. Gel à 1h et à 1h20. Bloc allure marathon raccourci pour ce palier.',
  ...
  10: { replace: { Mercredi: {
    ...
    echauff:'20 min footing EF à {{P}}.',
    corps:'2 × 4 km exactement à ton allure objectif marathon ({{OBJ}}). Récupération 3 min au trot. La même séance qu\'en semaine 9. Si tu les tiens facilement, ta préparation est solide.',
    retour:'10 min footing léger.',
