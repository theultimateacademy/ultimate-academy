...
module.exports = applyOverrides(base, {
  ...
  3: { replace: { Mercredi: {
    ...
    corps:'25 minutes continues à {{P}}. Allure légèrement plus haute que la trame. Difficile mais tenable. Si tu dois ralentir avant la fin, l\'allure cible est trop ambitieuse.',
    note:'RPE 8/10 · L\'allure seuil à 86% VMA est adaptée au palier avancé.' },
    Vendredi: {
    titre:'5 × 1000 mètres', pcts:[[65,65],[90,95]],
    corps:'5 × 1000m à {{P}}. Une répétition de plus que la trame. Récupération 2 min au trot. Termine par 1 km à ton allure objectif marathon ({{OBJ}}).',
    note:'RPE 7-8/10 · Pour le palier avancé, 1000m est la distance d\'intervalle de référence.' },
    Dimanche: { duree:'105 min',
    corps:'105 min à {{P}}. Régulier, hydraté, concentré sur ta foulée.',
  ...
  4: { replace: { Mercredi: {
    ...
    Vendredi: {
    titre:'6 × 1000 mètres', pcts:[[65,65],[90,95]],
    corps:'6 × 1000m à {{P}}. Récupération 2 min au trot. Termine par 1 km à {{OBJ}}. Régulier sur les 6.',
    note:'RPE 8/10 · Deux séances de qualité exigeantes en 3 jours. La fatigue est normale.' },
