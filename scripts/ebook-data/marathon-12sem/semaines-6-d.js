...
module.exports = applyOverrides(base, {
  ...
  6: { replace: {
    ...
    Dimanche: { duree:'2h',
    corps:'2h à {{P}}, avec 6 km à allure marathon ({{OBJ}}) en fin de sortie. Gel à 1h et à 1h20.',
  ...
  10: { replace: {
    ...
    Dimanche: { duree:'1h50',
    corps:'1h25 à {{P}}, puis 8 km à ton allure objectif marathon ({{OBJ}}). Gel à 1h et à 1h10.',
    note:'RPE 5-6/10 en EF · 7/10 sur les 8 km · Dernière sortie longue chargée pour ce palier.' } } },
})
