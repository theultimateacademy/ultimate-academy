...
// Surcharges : côtes plus nombreuses, intervalles plus longs, allures plus élevées, SL plus longues
...
module.exports = applyOverrides(base, {
  ...
  7: { replace: {
    ...
    titre:'2 × 25 minutes au seuil', pcts:[[65,70],[84,88]],
    echauff:'25 min progressif à {{P}}, finir par 4 accélérations 80m.',
    corps:'2 × 25 min à {{P}} avec 3 min de récupération. 50 min totales au seuil à allure avancée avec la fatigue de mercredi dans les jambes.',
    retour:'10 min footing très lent.',
