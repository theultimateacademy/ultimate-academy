...
function renderHtml({ vma, seances }) {
  ...
  const SEMAINES = require(`../ebook-data/marathon-12sem/semaines-${seances}-${tier}.js`)
...
<div class="page">
  ...
  <div class="som-flat">
    ...
    ${[
      ['Semaines 1-2 · Adaptation','5-6'],
      ['Semaines 3-4 · Développement aérobie','7-8'],
      ['Semaines 5-6 · Volume','9-10'],
      ['Semaines 7-8 · Intensification','11-12'],
      ['Semaines 9-10 · Spécificité marathon','13-14'],
      ['Semaine 11 · Consolidation','15'],
      ['Semaine 12 · Semaine de course','16'],
    ].map(([l,p])=>
      `<div class="som-item"><span class="som-label">${l}</span><span class="som-dots"></span><span class="som-page">p.${p}</span></div>`
    ).join('')}
    <div class="som-glbl">Course &amp; après</div>
    ${[['Stratégie de course','17'],['Nutrition avant et pendant','18'],['Coaching personnalisé','19']].map(([l,p])=>
      `<div class="som-item"><span class="som-label">${l}</span><span class="som-dots"></span><span class="som-page">p.${p}</span></div>`
    ).join('')}
  </div>
...
<div class="page">
  ...
  <div class="principes-wrap">
    ${[
      ['01','L\'endurance fondamentale, le socle du marathon','70 à 80% de ton volume total s\'effectue en Endurance Fondamentale. C\'est la base sur laquelle tout repose. Le marathon est avant tout une épreuve aérobie, et cette base se construit patiemment sur 12 semaines.'],
...
<div class="page">
  ...
  <div class="pnum">${gradText('18', { sizePt: 14, weight: 800, width: 40, align: 'end' })}</div>
</div>
...
<div class="page page-fin">
  ...
  <div class="pnum">${gradText('19', { sizePt: 14, weight: 800, width: 40, align: 'end' })}</div>
</div>
