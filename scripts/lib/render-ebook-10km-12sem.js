...
function fillText(text, pctQueue, vma) {
  ...
  out = out.replace(/{{OBJ}}/g, () => HL(formatObjPace(vma)))
  out = applyHL(out)
  return out
}
...
function renderHtml({ vma, seances }) {
  ...
  const SEMAINES = require(`../ebook-data/10km-12sem/semaines-${seances}-${tier}.js`)
...
<div class="page">
  ...
  <div class="som-flat">
    ...
    ${[
      ...
      ['Semaines 5-6 · Développement VMA','9-10'],
      ['Semaines 7-8 · Intensification','11-12'],
      ['Semaines 9-10 · Spécificité','13-14'],
...
<div class="page">
  ...
  <p class="page-intro">Les règles qui font la différence entre progresser et stagner sur 12 semaines.</p>
